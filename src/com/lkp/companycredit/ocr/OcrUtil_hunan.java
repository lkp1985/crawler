...
//                continue;  
    ...
    public static String getAllOcr(String file) throws Exception {  
        ...
        List<BufferedImage> splitHorList = splitImageHorizontal(img);
    ...
    public static void drawTempImage(BufferedImage img, String name, int width,
		...
		try {
			ImageIO.write(inputbig, "jpg", new File(imagePath+"split/" + name + ".jpg"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
...
//        }  
    ...
    public static void main(String[] args) throws Exception {  
        ...
        // trainData();  
        for (int i = 1; i <= 20; ++i) {  
            String text = getAllOcr("D:/workspace_lkp/crawler_task/ocr/company/sample/" + i+ ".jpg");  

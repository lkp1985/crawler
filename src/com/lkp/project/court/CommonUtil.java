...
public class CommonUtil {
	...
	public static String cookie ="CookieValue; CookieName=CookieValue; _gscu_1049835508=55947827xhyh0717; _pk_id.1.cf4c=3f0de15842e55247.1455947834.3.1456018299.1456018257.; __jsluid=4fef5efded1deab4c09a4ce525f034be; ASP.NET_SessionId=y0uwlbuanixiywlnpjf0rmsc; _gscu_1241932522=557987759brzvg16; _gscbrs_1241932522=1; _gsref_1241932522=http://www.court.gov.cn/zgcpwsw/; __jsl_clearance=1456159951.53|0|tUKdr0m4%2By%2B2Z5nUKtQh1cCIKyg%3D";
	...
	public static String getSPZ(String res){
		try{
			int index1 = res.indexOf(">���С���");
			if(index1==-1){
				index1 = res.indexOf(">���г�");
	...
	public static void runByDate(String begindate,String enddate,String errorfile){
		...
		//String cookie = "CookieName=CookieValue; CookieName=CookieValue; _gscu_1049835508=55947827xhyh0717; _pk_id.1.cf4c=3f0de15842e55247.1455947834.3.1456018299.1456018257.; __jsluid=4fef5efded1deab4c09a4ce525f034be; __jsl_clearance=1456131882.809|0|obo2NPwYVnTrlEg1MNxQJi1XUbM%3D; _gscu_1241932522=557987759brzvg16; _gscs_1241932522=t56128416y139ix17|pv:19; _gscbrs_1241932522=1; _gsref_1241932522=http://www.court.gov.cn/zgcpwsw/";
				...
				if(total>500){
					...
					for(int i=1;i<=total/20+1;i++){
						...
						for(Object obj : array){
							...
							doc.addField("insertdate", DateUtil.dateToStr(new Date(), DateUtil.DATE_FORMAT_YYYY_MM_DD));
	...
	public static void main(String[] args)throws Exception {
		...
		//com.lkp.proxy.HttpProxy.setProxy("172.16.106.90", "8119");
		try {
			idWriter = new FileWriter("D:\\workspace_lkp\\crawler_task\\output\\id_publishdate.txt");
		} catch (IOException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		BufferedReader br = new BufferedReader(new FileReader("D:\\workspace_sds\\VulCheckApp\\output\\20160222234725outputurl.txt"));
		String line = "";
		...
		br.close();
		for(int i=0;i<10;i++){
			FirThread fir = new FirThread(cookie, idWriter);

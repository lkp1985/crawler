...
//	    		httppost.setHeader("dnt", "1");
	...
	public static List<String> getProvinceCodeList() {
	 ...
	 //"xj","jx","ln","han","js",//"gd","snx","heb","hub","jl","nx","tj","fj","bj","zj",//"hen","sx",//"hun","gz","hlj","gx","sd","sc","qh","xz","sh",
	...
	public static List<String> getzibenList() {
		...
		zibenList.add("moneyStart=0&moneyEnd=100");
		zibenList.add("moneyStart=100&moneyEnd=200");
		zibenList.add("moneyStart=200&moneyEnd=500");
		zibenList.add("moneyStart=500&moneyEnd=1000");
		zibenList.add("moneyStart=1000&moneyEnd=200000");
